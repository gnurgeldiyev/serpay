 ...
 */
router.post("/", authMiddleware, poetController.add);
 ...
 * PUT requests
 */
router.put("/:id", authMiddleware, poetController.update);
router.put("/:id/delete", authMiddleware, poetController.delete);
