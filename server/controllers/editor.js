...
const { validateData, validateLoginData, hashPassword, decodePassword, generateToken } = require('../helpers/editor')
...
exports.update = async (req, res) => {
    ...
    d.id = id
    const result = await validateData('update', d)
    if (!result.status) {
        return res.status(400).json({
            data: {},
            meta: { code: 400, error: result.error },
