...
export const actions = {
    ...
    fetchAllUnapproved({ commit }, data) {
        return this.$axios
            .$get(`/api/poems?approved=false&poet=${data}`)
            .then((res) => {
    ...
    approve({ commit }, data) {
        return this.$axios
            .$put(`/api/poems/${data}/approve?approved=true`)
            .then((res) => {
                commit('add', res.data)
    ...
    unapprove({ commit }, data) {
        return this.$axios
            .$put(`/api/poems/${data}/approve?approved=false`)
            .then((res) => {
                commit('addUnapproved', res.data)
