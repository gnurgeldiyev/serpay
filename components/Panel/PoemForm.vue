            ...
            <el-form ref="form" :model="form" :rules="rules" class="form">
                ...
                <el-form-item prop="author" label="Author">
                    <el-select
                        ...
                        style="width: 100%"
                    >
                        <el-option v-for="poet in poets" :key="poet.id" :label="poet.fullname" :value="poet.id" />
                    </el-select>
                </el-form-item>
                ...
                <el-form-item prop="youtube_link" label="YouTube Video Link">
                    <el-input
                ...
                <el-form-item prop="content" label="Poem">
...
export default {
    ...
    data() {
        const validateVideoLink = (rule, value, callback) => {
            ...
            if (value && value !== '') {
                const result = ytRgx.test(this.form.youtube_link)
                if (result) {
                    callback()
                } else {
        ...
        return {
            ...
            rules: {
                ...
                notes: [{ min: 0, max: 300, message: 'Length should be max 300 characters', trigger: 'blur' }],
                category: [
                    {
                        type: 'array',
                        required: true,
                ...
                youtube_link: [{ validator: validateVideoLink, trigger: 'blur' }],
                author: [{ required: true, message: 'Please select the author', trigger: 'blur' }],
                year: [{ validator: checkYear, trigger: 'blur' }],
                content: [{ required: true, message: 'Poem content cannot be blank', trigger: 'blur' }],
            },
        }
    },
    computed: {
