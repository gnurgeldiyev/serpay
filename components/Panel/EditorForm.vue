        ...
        >
            <el-form ref="form" :model="form" :rules="rules" class="form">
                ...
                <el-form-item prop="firstname" label="First Name">
                    <el-input v-model="form.firstname" autocomplete="off" placeholder="Amalie" />
                </el-form-item>
                <el-form-item prop="lastname" label="Last Name">
                    <el-input v-model="form.lastname" autocomplete="off" placeholder="Stone" />
                </el-form-item>
                <el-form-item prop="email" label="Email Address">
                    <el-input v-model="form.email" autocomplete="off" placeholder="example@mail.com" />
                </el-form-item>
                <el-form-item v-if="type === 'add'" prop="password" label="User Password">
                    <el-input v-model="form.password" type="password" autocomplete="off" placeholder="••••••••" />
                </el-form-item>
                <el-form-item prop="role" label="Editor Role">
                    <el-select v-model="form.role" style="width: 100%" placeholder="Select editor role">
    ...
    data() {
        return {
            ...
            rules: {
                ...
                role: [{ required: true, message: 'Please select editor role', trigger: 'change' }],
            },
        }
    },
    computed: {
